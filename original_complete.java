...
public void pm_AskEPI_Login_OTP() {
    ...
    public void pm_RiskRealm_Admin_Web_Login_UI() {
        ...
        given()
            .when()
            .request("GET", "https://www.riskrealm.ai/")
            .then()
                .statusCode(200);
    }
    ...
    public void pm_RiskRealm_Chat_Web_Login_UI() {
        ...
        given()
            .when()
            .request("GET", "https://chat.riskrealm.ai/")
            .then()
                .statusCode(200);
    }
    ...
    public void pm_RiskRealm_Login_Number() {
        ...
        given()
            .urlEncodingEnabled(false)   // <-- important: keep the ":" in the path
            .contentType(ContentType.JSON)
            .body("{\"key\" : \"fUjZB3a/IJyX6AyCgxVZ4hHYh32MOfLDXj13XX7sJcZRao2wJZxK3KpfxcEEXQtU\"}")
            .when()
            .request("POST", "https://api.riskrealm.ai/ai/user/beforeLogincheckUser")
            .then()
                .statusCode(200);
    }
    ...
    public void pm_RiskRealm_Login_OTP() {
        ...
        given()
            ...
            .contentType(ContentType.JSON)
            .queryParam("key", "AIzaSyA02OjHzzCXgEnDBC1vS4zFdOSgs2HJzxg")
            .body("{\"sessionInfo\":\"AD8T5Iutql-QObyG54crilX-fHTZ2PqFVKDOxfz6_AkfzoR4QueOFmmGqS8nAydrQf7OWMEGnwcZAiWtTr_wmI9Bkcu3tNibHPgyUZt7XTMce5nvMC3RnI-RVJ6r9qsqeDnMh-5VpWuy\",\"code\":\"123456\"}")
            .when()
            .request("POST", "https://identitytoolkit.googleapis.com/v1/accounts:signInWithPhoneNumber?key=AIzaSyA02OjHzzCXgEnDBC1vS4zFdOSgs2HJzxg")
            .then()
                .statusCode(200);
    ...
    public void pm_AutoeVantage_eCommerce_Web_UI() {
        ...
        given()
            .when()
            .request("GET", "https://www.autoevantage.com/")
            .then()
                .statusCode(200);
    }
    ...
    public void pm_AutoeVantage_eCommerce_Login_OTP() {
        ...
        given()
            ...
            .contentType(ContentType.JSON)
            .queryParam("key", "AIzaSyBAf4PM4HeNcO0uuByCUWwZFIYMYHfwUik")
            .body("{\"sessionInfo\":\"AD8T5IuqwSLujETiVQS3r6Rtm6c7MiSxZ4m8O8ASb7AQJ3JydJPHGEoCiZxdaBmCtfgUOwVSMkYlrX3MYhiTRBlQlub488v59USE2m6xh6dP6u5CiFBX8y-Ow6KR35lDPS7NGbgwz60sf4KSsXpS9mCdMZDPA3Ncxg\",\"code\":\"123456\"}")
            .when()
            .request("POST", "https://identitytoolkit.googleapis.com/v1/accounts:signInWithPhoneNumber?key=AIzaSyBAf4PM4HeNcO0uuByCUWwZFIYMYHfwUik")
            .then()
                .statusCode(200);
    }
    ...
    public void pm_AutoeVantage_Tools_Web_UI() {
        ...
        given()
            .when()
            .request("GET", "https://tools.autoevantage.com/")
            .then()
                .statusCode(200);
    }
    ...
    public void pm_AutoeVantage_Tools_Login_OTP() {
        ...
        given()
            ...
            .contentType(ContentType.JSON)
            .queryParam("key", "AIzaSyBWHkUDpvKpigYPy2cpdfMHWOWiUl0CF2g")
            .body("{\"sessionInfo\":\"AD8T5IsH0Oyvy6zBlBilqSpTDknT5vh4HTMCLO4JhP2JMk3lekbwdilJHtpONpUzVlEx-E_5Eu2Kz9c6kKlFG5MzeYKIrRIAZ0J2pUEYY8b_wnRIwO-ROC6C9LFPSEX95aGQEohRh7IZ2JZMIaTxJt5o9M_CIDYObw\",\"code\":\"123456\"}")
            .when()
            .request("POST", "https://identitytoolkit.googleapis.com/v1/accounts:signInWithPhoneNumber?key=AIzaSyBWHkUDpvKpigYPy2cpdfMHWOWiUl0CF2g")
            .then()
                .statusCode(200);
    }
    ...
    public void pm_AutoeVantage_Analytics_Web_UI() {
        ...
        given()
            .body("")
            .when()
            .request("GET", "https://admin.autoevantage.com/")
            .then()
                .statusCode(200);
    }
    ...
    public void pm_AutoeVantage_Analytics_Login_OTP() {
        ...
        given()
            ...
            .contentType(ContentType.JSON)
            .queryParam("key", "AIzaSyBWHkUDpvKpigYPy2cpdfMHWOWiUl0CF2g")
            .body("{\"sessionInfo\":\"AD8T5It1Z6RSfnx75VNuLaP95YVstZRIkD-BVPeOavjCAnlxwwoZBW-QfRjq778YnHhCmz9wDejFmzyWfQz5nH6dUo9ei_4zb8FFTNvW-tz3WRj3d_PKu9cwwtNiE_cwH1oz0Uli4nPWIMAv75ofGHhCMbsoxErwkg\",\"code\":\"123456\"}")
            .when()
            .request("POST", "https://identitytoolkit.googleapis.com/v1/accounts:signInWithPhoneNumber?key=AIzaSyBWHkUDpvKpigYPy2cpdfMHWOWiUl0CF2g")
            .then()
                .statusCode(200);
